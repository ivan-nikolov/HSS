...
{
    public partial class AddInitialDesignEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveOn = table.Column<DateTime>(nullable: false),
                    BillingEndOn = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamServices", x => new { x.TeamId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_TeamServices_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeamServices_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Appartment = table.Column<string>(maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    ServiceFrequencyInDays = table.Column<int>(nullable: false),
                    Status = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamServices_ServiceId",
                table: "TeamServices",
                column: "ServiceId");
